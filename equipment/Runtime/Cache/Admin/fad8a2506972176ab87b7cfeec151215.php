        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
					<li class="active"><a href="/admin.php/Picture/index">图片管理</a></li>
				...
				<div class="tab-content">
					<div  class="tab-pane in active">
                        ...
                        <form action="/admin.php/Picture/index" method="post">
                        ...
                        <form action="/admin.php/Link/linkEdit" method="post">
                        	<?php if(is_array($pictureList)): foreach($pictureList as $key=>$picture): ?><div class="e8-pic">
	                                <img id="photo<?php echo ($picture["id"]); ?>" src="/images/<?php echo ($picture["qr_path"]); ?>" class="img-rounded" width="123" height="110">
